...
cl %options% ..\win32_main.cpp /link /LIBPATH:..\lib vulkan-1.lib msvcrt.lib raylib.lib OpenGL32.lib Gdi32.lib WinMM.lib kernel32.lib shell32.lib User32.lib /OUT:main.exe
