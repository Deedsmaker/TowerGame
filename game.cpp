...
i32 light_texture_width = 256;
i32 light_texture_height = 256;
...
void new_render(){
    ...
    // Currently baking distance data and emitters/occluders at one go, because that's simpler and I don't thing it's that huge
    // on gpu.
